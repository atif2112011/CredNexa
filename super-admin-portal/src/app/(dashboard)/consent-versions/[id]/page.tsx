    ...
    <>
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_360px]">
        <div className="space-y-6">
          ...
          <JsonPanel title="Consent Text" data={{ borrowerAgreementText: consent.borrowerAgreementText, deviceControlConsentText: consent.deviceControlConsentText, privacyPolicyText: consent.privacyPolicyText, tripartiteAckText: consent.tripartiteAckText }} />
        </div>
        <Card>
